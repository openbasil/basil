...
collect_outputs() {
  ...
  copy_retained_file "$scratch/podman-stage-binary.log" "$run/raw/podman-stage-binary.log"
  copy_retained_file "$scratch/podman-stage-install.log" "$run/raw/podman-stage-install.log"
  copy_retained_file "$scratch/podman-stage-closure.log" "$run/raw/podman-stage-closure.log"
  copy_retained_file "$scratch/podman-owner-a.log" "$run/raw/podman-owner-a.log"
  copy_retained_file "$scratch/podman-owner-b.log" "$run/raw/podman-owner-b.log"
  copy_retained_file "$scratch/podman-unit-trust.log" "$run/raw/podman-unit-trust.log"
  copy_retained_file "$scratch/podman-outage.log" "$run/raw/podman-outage.log"
  copy_retained_file "$scratch/podman-rootful-rejection.log" "$run/raw/podman-rootful-rejection.log"
  copy_retained_file "$scratch/podman-scale.log" "$run/raw/podman-scale.log"
