...
pkgs.testers.nixosTest {
  ...
  testScript = ''
    ...
    POLICY_A = '{"schema":"policy","subjects":{"breakglass.root":{"domain":"host-process","breakGlass":true,"match":{"all":[{"process.uid":0}]}}},"roles":{"signer":["sign","verify","get_public_key"]},"rules":[{"id":"tpm-e2e-signer","subjects":["breakglass.root"],"action":["role:signer"],"target":["example.signing_key"]}],"config":{"names":{"users":{"0":"root"},"groups":{}},"memberships":{"0":[0]}}}'
