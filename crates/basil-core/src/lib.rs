...
pub use core::{
    actor, attestor_realm, attestor_realm_unix, audit, backend, capability, catalog, configuration,
    decision, ed25519_sign, event, manager, minter, ml_kem_envelope, peer, reconcile,
    release_admission, reload, revocation, seal, state, x25519_seal,
};
...
pub use configuration::{
    ...
    ConfigurationTraceContext, CorpusDocuments, CorpusSources, DEFAULT_CONFIG_PATH,
    LoadedBootstrap, OverrideProvenance, install_compose_document, load_bootstrap,
    load_bootstrap_with_context, load_documents, load_documents_with_overrides,
